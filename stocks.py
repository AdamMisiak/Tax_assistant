...
def calculate_tax_to_pay(opening_transaction: dict, closing_transaction: dict) -> float:
    ...
    print(f"Open rate {opening_transaction['currency']}: {opening_transaction_rate} - Close rate {closing_transaction['currency']}: {closing_transaction_rate} - Profit/Loss PLN: {profit_or_loss_in_pln} - Tax rate: {tax_rate*100}% - Tax PLN: {total_tax_to_paid_in_pln}")
    print('--'*50)
